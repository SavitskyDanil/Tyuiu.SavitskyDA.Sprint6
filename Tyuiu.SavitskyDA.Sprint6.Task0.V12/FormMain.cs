...
using Tyuiu.SavitskyDA.Sprint6.Task0.V12.Lib;
...
namespace Tyuiu.SavitskyDA.Sprint6.Task0.V12
{
    public partial class FormMain : Form
    {
        ...
        private void buttonPushMe_SDA_Click(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("Таск 0 выполнил студент группы АСОиУб-23-1 Савицкий Данил Александрович", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
