...
using Tyuiu.SavitskyDA.Sprint6.Task2.V9.Lib;

namespace Tyuiu.SavitskyDA.Sprint6.Task2.V9
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 2 выполнил студент группы АСОиУб-23-1 Савицкий Данил Александрович", "Сообщение", MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
    }
}
